...
else
{
	...
	report_error("action.php : failed to open the xml file containing search keywords");
}
...
else
{
	...
	report_error("action.php : failed to open the xml file containing publications listing");
}
